...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF4C7B5F);
  late Color secondary = const Color(0xFFF4EDE7);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF2E2B22);
  late Color secondaryText = const Color(0xFF5F5B53);
  late Color primaryBackground = const Color(0xFFF9F7F1);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4DBCCFCC);
  late Color accent2 = const Color(0xFFF4EDE7);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFD3D3D3);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF4C7B5F);
  late Color secondary = const Color(0xFF1F1E1C);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFF262D34);
  late Color primaryText = const Color(0xFFE5E5E3);
  late Color secondaryText = const Color(0xFFA4A49C);
  late Color primaryBackground = const Color(0xFF262624);
  late Color secondaryBackground = const Color(0xFF14181B);
  late Color accent1 = const Color(0xFF3D3D3B);
  late Color accent2 = const Color(0xFF1F1E1C);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xB2262D34);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFF2C2F2D);

  late Color customColor1 = const Color(0xFF1F1E1C);
}
